...
![10秒打戏运镜时间轴](references/cc7f07f4-d0a4-4c45-9d18-e5b7f2904c03.jpg)

**核心原则**：快！跟随 + 切换是主菜🍚，环绕是甜点🍰

| 时间段 | 运镜要素 | 镜头数量 | 核心作用 |
|:---:|:---:|:---:|------|
| **0-2.5s** | 快速跟随 | 1-2个 | 建立空间+气势冲突 |
| **2.5-6.5s** | 快速切换 | 6-10个(最密集) | 连续对打+节奏加速 |
| **6.5-8s** | 快速环绕 | 1个 | 高潮爆发+气势放大 |
| **8-10s** | 跟随收尾 | 1-2个 | 结果确认+情绪释放 |

**全程建议**：10秒内切换不少于8个镜头
**核心口诀**：快跟随→快切换→快环绕→收尾给情绪
